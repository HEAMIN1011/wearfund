            ...
            <div className="back">
                <div className="flex">
                    <div className="boxBack boxNav">펀딩으로 디자이너의 걱정을 없앤다고?
                        <div className="white1">패션디자이너는 창의력과 혁신의 최전선에 있습니다. 그들의 디자인과 아이디어는 트렌드를 선도하며, 새로운 스타일과 패턴을 만들어냅니다.</div>
                    ...
                    <div className="boxBack boxNav" >새로운 시도를 응원할 수 있습니다.
                        <div className="white1">패션은 전 세계적으로 중요한 산업입니다. 뛰어난 디자이너와 협력하면 글로벌 시장에서의 입지를 강화할 수 있습니다.</div>
